...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\mihai\PycharmProjects\tg-gpt-bot\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\mihai\PycharmProjects\tg-gpt-bot\venv\Scripts\deactivate.nu'
